			...
			<div class="navbar-content scroll-div " >
				...
				<div class="">
					<div class="main-menu-header">
						<img class="{{asset('ablepro-master')}}/img-radius" src="assets/images/user/avatar-2.jpg" alt="User-Profile-Image">
								...
								<div class="dropdown-menu dropdown-menu-right notification">
									...
									<ul class="noti-body">
										...
										<li class="notification">
											<div class="media">
												<img class="{{asset('')}}/img-radius" src="assets/images/user/avatar-1.jpg" alt="Generic placeholder image">
										...
										<li class="notification">
											<div class="media">
												<img class="{{asset('')}}/img-radius" src="assets/images/user/avatar-2.jpg" alt="Generic placeholder image">
												<div class="media-body">
						...
						<li>
							<div class="dropdown drp-user">
								...
								<div class="dropdown-menu dropdown-menu-right profile-notification">
									<div class="pro-head">
										<img src="assets/images/user/avatar-1.jpg" class="{{asset('')}}/img-radius" alt="User-Profile-Image">
										<span>John Doe</span>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="assets/images/user/avatar-4.jpg" alt="user image" class="{{asset('')}}/img-radius wid-40 align-top m-r-15">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="assets/images/user/avatar-2.jpg" alt="user image" class="{{asset('')}}/img-radius wid-40 align-top m-r-15">
                                                <div class="d-inline-block">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="assets/images/user/avatar-3.jpg" alt="user image" class="{{asset('')}}/img-radius wid-40 align-top m-r-15">
                                                <div class="d-inline-block">
                                                    <h6>William Jem</h6>
                        ...
                        <div class="review-block">
                            <div class="row">
                                <div class="col-sm-auto p-r-0">
                                    <img src="assets/images/user/avatar-2.jpg" alt="user image" class="{{asset('')}}/img-radius profile-img cust-img m-b-15">
                                </div>
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col-sm-auto p-r-0">
                                    <img src="assets/images/user/avatar-4.jpg" alt="user image" class="{{asset('')}}/img-radius profile-img cust-img m-b-15">
                                </div>
                                <div class="col">
                    ...
                    <div class="card-body">
                        <div class="row m-b-20 received-chat">
                            <div class="col-auto p-r-0">
                                <img src="assets/images/user/avatar-2.jpg" alt="user image" class="{{asset('')}}/img-radius wid-40">
                            </div>
                            <div class="col">
                                <div class="msg">
                        ...
                        <div class="row m-b-20 send-chat">
                            ...
                            <div class="col-auto p-l-0">
                                <img src="assets/images/user/avatar-3.jpg" alt="user image" class="{{asset('')}}/img-radius wid-40">
                            </div>
                        </div>
                        <div class="row m-b-20 received-chat">
                            <div class="col-auto p-r-0">
