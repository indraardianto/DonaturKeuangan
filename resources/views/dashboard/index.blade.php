		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="index.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Dashboard Keuangan</span></a>
					</li>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="asset/images/user/avatar-4.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="asset/images/user/avatar-2.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                                <div class="d-inline-block">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="asset/images/user/avatar-3.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                                <div class="d-inline-block">
                                                    <h6>William Jem</h6>
                        ...
                        <div class="review-block">
                            <div class="row">
                                <div class="col-sm-auto p-r-0">
                                    <img src="asset/images/user/avatar-2.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                                </div>
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col-sm-auto p-r-0">
                                    <img src="asset/images/user/avatar-4.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                                </div>
                                <div class="col">
                    ...
                    <div class="card-body">
                        <div class="row m-b-20 received-chat">
                            <div class="col-auto p-r-0">
                                <img src="asset/images/user/avatar-2.jpg" alt="user image" class="img-radius wid-40">
                            </div>
                            <div class="col">
                                <div class="msg">
                        ...
                        <div class="row m-b-20 send-chat">
                            ...
                            <div class="col-auto p-l-0">
                                <img src="asset/images/user/avatar-3.jpg" alt="user image" class="img-radius wid-40">
                            </div>
                        </div>
                        <div class="row m-b-20 received-chat">
                            <div class="col-auto p-r-0">
